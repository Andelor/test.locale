...
( function ( mw, $ ) {
	...
	QUnit.test( '_normalizeTargetInUri', function ( assert ) {
		var cases = [
			...
			{
				input: 'http://host/w/index.phtml?title=Special:RecentChangesLinked/Moai',
				output: 'http://host/w/index.phtml?title=Special:RecentChangesLinked&target=Moai',
				message: 'Target as subpage in title param'
			},
			{
				input: 'http://host/w/index.phtml?title=Special:RecentChangesLinked/Moai/Sub1',
				output: 'http://host/w/index.phtml?title=Special:RecentChangesLinked&target=Moai/Sub1',
				message: 'Target as subpage in title param also has a subpage'
			},
			{
				input: 'http://host/w/index.phtml?title=Special:RecentChangesLinked/Category:Foo/Bar',
				output: 'http://host/w/index.phtml?title=Special:RecentChangesLinked&target=Category:Foo/Bar',
