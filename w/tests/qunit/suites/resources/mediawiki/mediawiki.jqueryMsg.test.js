( function ( mw, $ ) {
	...
	QUnit.module( 'mediawiki.jqueryMsg', QUnit.newMwEnvironment( {
		setup: function () {
			...
			expectedEntrypoints = '<a href="https://www.mediawiki.org/wiki/Manual:index.phtml">index.phtml</a>';
		...
		messages: {
			...
			'jquerymsg-test-version-entrypoints-index-php': '[https://www.mediawiki.org/wiki/Manual:index.phtml index.phtml]',
