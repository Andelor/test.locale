...
class UploadBaseTest extends MediaWikiTestCase {
	...
	public static function provideCheckSvgScriptCallback() {
		...
		return [
			...
			[
				'<?xml version="1.0" ?> <?xml-stylesheet type="text/xsl" href="/w/index.phtml?title=User:Jeeves/test.xsl&amp;action=raw&amp;format=xml" ?> <svg> <height>50</height> <width>100</width> </svg>',
				true,
				true,
