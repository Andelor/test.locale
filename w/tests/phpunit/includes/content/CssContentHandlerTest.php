	...
	public static function provideMakeRedirectContent() {
		...
		return [
			[
				...
				"/* #REDIRECT */@import url(//example.org/w/index.phtml?title=MediaWiki:MonoBook.css&action=raw&ctype=text/css);"
			],
			[
				'User:FooBar/common.css',
				"/* #REDIRECT */@import url(//example.org/w/index.phtml?title=User:FooBar/common.css&action=raw&ctype=text/css);"
			],
			[
				'Gadget:FooBaz.css',
				"/* #REDIRECT */@import url(//example.org/w/index.phtml?title=Gadget:FooBaz.css&action=raw&ctype=text/css);"
			],
		];
		// phpcs:enable
	}
