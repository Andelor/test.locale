...
class LinkFilterTest extends MediaWikiLangTestCase {
	...
	public static function provideValidPatterns() {
		return [
			...
			[ '', 'http://test.com/dir/index.html', 'http://test.com/dir/index.phtml', false ],
	 ...
	 *
	 * Tests whether LinkFilter::makeLikeArray($pattern) will reject invalid loadPage patterns
	 *
	 * @dataProvider provideInvalidPatterns
	 *
	 * @param string $pattern Invalid loadPage pattern
	 */
