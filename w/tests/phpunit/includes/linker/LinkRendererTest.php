...
class LinkRendererTest extends MediaWikiLangTestCase {
	...
	public function testMakeKnownLink() {
		...
		// Query added
		$this->assertEquals(
			'<a href="/w/index.phtml?title=Foobar&amp;foo=bar" '. 'title="Foobar">Foobar</a>',
	...
	public function testMakeBrokenLink() {
		...
		$this->assertEquals(
			'<a href="/w/index.phtml?title=Foobar&amp;action=edit&amp;redlink=1" '
		...
		$this->assertEquals(
			'<a href="/w/index.phtml?title=Foobar&amp;action=foobar" class="new" '
