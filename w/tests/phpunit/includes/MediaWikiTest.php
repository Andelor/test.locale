...
class MediaWikiTest extends MediaWikiTestCase {
	...
	public static function provideTryNormaliseRedirect() {
		return [
			...
			[
				// View: Script path
				'url' => 'http://example.org/w/index.phtml?title=Foo_Bar',
				'query' => [ 'title' => 'Foo_Bar' ],
				'title' => 'Foo_Bar',
				'redirect' => false,
			],
			[
				...
				'url' => 'http://example.org/w/index.phtml?curid=123',
				'query' => [ 'curid' => '123' ],
				'title' => 'Foo_Bar',
				'redirect' => false,
			],
			[
				...
				'url' => 'http://example.org/w/index.phtml?oldid=123',
				'query' => [ 'oldid' => '123' ],
				'title' => 'Foo_Bar',
				'redirect' => false,
			],
			[
				...
				'url' => 'http://example.org/w/index.phtml',
				'query' => [],
				'title' => 'Main_Page',
			...
			[
				...
				'url' => 'http://example.org/w/index.phtml?title=',
				'query' => [ 'title' => '' ],
				'title' => 'Main_Page',
				'redirect' => 'http://example.org/wiki/Main_Page',
			],
			[
				...
				'url' => 'http://example.org/w/index.phtml?title=Foo%20Bar',
				'query' => [ 'title' => 'Foo Bar' ],
				'title' => 'Foo_Bar',
				'redirect' => 'http://example.org/wiki/Foo_Bar',
			],
			...
			[
				...
				'url' => 'http://example.org/w/index.phtml?title=Foo_Bar&action=view',
			...
			[
				...
				'url' => 'http://example.org/w/index.phtml?title=Foo_Bar&action=edit',
