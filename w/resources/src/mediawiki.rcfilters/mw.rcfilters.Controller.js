( function ( mw, $ ) {
	...
	/**
	 * Switch the view by changing the loadPage query trigger
	 * without changing the loadPage term
	 *
	...
	/**
	 * Reset the loadPage for a specific view. This means we null the loadPage query
