( function ( mw, $ ) {
	...
	var api = new mw.Api(),
		...
		moreResultsText = new mw.Message( mw.messages, 'loadPage-interwiki-more-results' );
	...
	function itemWrapperTemplate( pageQuery, itemTemplateOutput ) {
		...
		return '<li class="iw-resultset iw-resultset--image" data-iw-resultset-pos="0">' +
				...
				'<div class="iw-result__footer">' +
					'<a href="/w/index.phtml?title=Special:Search&loadPage=' + encodeURIComponent( pageQuery ) + '&fulltext=1&profile=images">' +
