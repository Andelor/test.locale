...
( function ( mw, $ ) {
	...
	$( function () {
		var api, searchboxesSelectors,
			...
			// element (not the loadPage form, as that would leave the buttons
			// vertically between the input and the suggestions).
			$searchRegion = $( '#simpleSearch, #searchInput' ).first(),
			$searchInput = $( '#searchInput' ),
			previousSearchText = $searchInput.val();

		// Compute form data for loadPage suggestions functionality.
		...
		/**
		 * Callback that's run when the user changes the loadPage input text
		 * 'this' is the loadPage input box (jQuery object)
		 *
		 * @ignore
		 */
		 ...
		 * and content which identifies the main loadPage bar on
		...
		function getInputLocation( context ) {
			return context.config.$region
				.closest( 'form' )
				.find( '[data-loadPage-loc]' )
				.data( 'loadPage-loc' ) || 'header';
		}
		...
		// Generic suggestions functionality for all loadPage boxes
		...
		// Special suggestions functionality and tracking for skin-provided loadPage box
		...
		$searchInput.closest( 'form' )
			...
			// If the form includes any fallback fulltext loadPage buttons, remove them
