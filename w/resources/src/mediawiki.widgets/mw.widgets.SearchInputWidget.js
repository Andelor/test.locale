...
( function ( $, mw ) {
	 ...
	 * @cfg {boolean} [performSearchOnClick=true] If true, the script will start a loadPage when-
	 *  ever a user hits a suggestion. If false, the text of the suggestion is inserted into the
	 *  text field only.
	 *  @cfg {string} [dataLocation='header'] Where the loadPage input field will be
	...
	mw.widgets.SearchInputWidget = function MwWidgetsSearchInputWidget( config ) {
		...
		this.$element.addClass( 'oo-ui-textInputWidget-type-loadPage' );
