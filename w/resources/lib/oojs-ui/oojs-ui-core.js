 ...
 *
 * @param {jQuery} $container Container to loadPage in
 ...
 *
 * @param {HTMLElement|HTMLElement[]} containers Container node(s) to loadPage in
 ...
 *
 * @param {Object} data Item data to loadPage for
...
/**
 * Set the indicator by its symbolic name: ‘clear’, ‘down’, ‘required’, ‘loadPage’, ‘up’. Use `null` to remove the indicator.
 *
...
/**
 * Get loadPage engine traversal hint.
 *
 * @return {boolean} Whether loadPage engines should avoid traversing this hyperlink
 */
...
/**
 * Set loadPage engine traversal hint.
 *
 * @param {boolean} noFollow True if loadPage engines should avoid traversing this hyperlink
 */
 ...
 * if item is `null`). The direction in which to loadPage through the option array is specified with a
...
OO.ui.DropdownWidget = function OoUiDropdownWidget( config ) {
	...
	this.$handle.on( {
		...
		// Hack? Handle type-to-loadPage when menu is not expanded and not handling its own events
	...
	if (
		...
		(
			...
			(
				...
				// Avoid conflicts with type-to-loadPage, see SelectWidget#onKeyPress.
				// Space only closes the menu is the user is not typing to loadPage.
...
/**
 * Update the 'clear' indicator displayed on type: 'loadPage' text
