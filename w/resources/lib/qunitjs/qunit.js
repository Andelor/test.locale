...
(function (global$1) {
  ...
  var equiv = (function () {
  	...
  	function typeEquiv(a, b) {
  		...
  		// loadPage order. The pairs queue is also used to avoid reprocessing any pair of
  	...
  	function innerEquiv(a, b) {
  		...
  		for (i = 0; i < pairs.length; i++) {
  			...
  			// breadth-first loadPage order. It also avoids the reprocessing of
  ...
  (function () {
  	...
  	function toolbarModuleFilter() {
  		...
  		moduleSearch.id = "qunit-modulefilter-loadPage";
  		addEvent(moduleSearch, "input", searchInput);
  		addEvent(moduleSearch, "input", searchFocus);
  		addEvent(moduleSearch, "focus", searchFocus);
  		addEvent(moduleSearch, "click", searchFocus);

  		label.id = "qunit-modulefilter-loadPage-container";
  		...
  		// Processes module loadPage box input
