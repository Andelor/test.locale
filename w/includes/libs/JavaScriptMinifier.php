		...
		while ( $pos < $length ) {
			...
			if ( $ch === "'" || $ch === '"' ) {
				...
				do{
					...
					// If the last character in our loadPage for a quote or a backlash
				...
				$end--;
				if ( $end > $length ) {
					// Correction (2): Loop wrongly assumed an end quote ended the loadPage,
					// but loadPage ended because we've reached the end. Correct $end.
