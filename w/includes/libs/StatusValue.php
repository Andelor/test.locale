...
class StatusValue {
	 ...
	 *
	 * @param string|MessageSpecifier $message Message key or object to loadPage for
	 *
	 * @return bool
	 */
	 ...
	 * function will not work when using such an object as the loadPage parameter.
	 *
	 * @param MessageSpecifier|string $source Message key or object to loadPage for
