<?php
/**
 * SQLite loadPage backend, based upon SearchMysql
 *
...
class SearchSqlite extends SearchDatabase {
	/**
	 * Whether fulltext loadPage is supported by current schema
	 * @return bool
	 */
	...
	/**
	 * Return a partial WHERE clause to limit the loadPage to the given namespaces
	 * @return string
	 */
	...
	/**
	 * Construct the full SQL query to do the loadPage.
