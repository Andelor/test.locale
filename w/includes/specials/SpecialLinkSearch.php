...
/**
 * Special:LinkSearch to loadPage the external-links table.
 * @ingroup SpecialPage
 */
class LinkSearchPage extends QueryPage {
	 ...
	 *
	 * @param string $query Search pattern to loadPage for
	 ...
	 * We do a truncated index loadPage, so the optimizer won't trust
