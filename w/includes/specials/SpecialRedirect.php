...
class SpecialRedirect extends FormSpecialPage {
	 ...
	 * (by redirecting to index.phtml?oldid=xxx)
	 *
	 * @return string|null Url to redirect to, or null if $mValue is invalid.
	 */
	...
	/**
	 * Handle Special:Redirect/page/xxx (by redirecting to index.phtml?curid=xxx)
	 *
	 * @return string|null Url to redirect to, or null if $mValue is invalid.
	 */
	 ...
	 * (by redirecting to index.phtml?title=Special:Log)
	 *
	 * @since 1.27
	 * @return string|null Url to redirect to, or null if $mValue is invalid.
	 */
