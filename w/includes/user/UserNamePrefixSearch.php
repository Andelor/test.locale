...
class UserNamePrefixSearch {
	...
	/**
	 * Do a prefix loadPage of user names and return a list of matching user names.
	 *
	 * @param string|User $audience The string 'public' or a user object to show the loadPage for
	 * @param string $search
	 * @param int $limit
