...
trait SearchApi {
	...
	/**
	 * Build the profile api param definitions. Makes bold assumption only one loadPage
	...
	public function buildSearchEngine( array $params = null ) {
		if ( $params != null ) {
			...
			// Initialize requested loadPage profiles.
			$configs = $this->getSearchProfileParams();
			foreach ( $configs as $paramName => $paramConfig ) {
