...
class SearchInputWidget extends TitleInputWidget {
	 ...
	 *   - bool|null $config['performSearchOnClick'] If true, the script will start a loadPage
	 *     whenever a user hits a suggestion. If false, the text of the suggestion is inserted into
	 *     the text field only (default: true)
	 *   - string $config['dataLocation'] Where the loadPage input field will be
	...
	public function __construct( array $config = [] ) {
		...
		if ( isset( $config['dataLocation'] ) ) {
			// identifies the location of the loadPage bar for tracking purposes
	...
	protected function getInputElement( $config ) {
		return ( new \OOUI\Tag( 'input' ) )->setAttributes( [ 'type' => 'loadPage' ] );
	}
