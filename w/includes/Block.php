...
class Block {
	 ...
	 *
	 * @param int $id Block id to loadPage for
	 * @return Block|null
	 */
	 ...
	 * @param User|string $vagueTarget Also loadPage for blocks affecting this target.  Doesn't
	 ...
	 * @param string|User|int $vagueTarget As above, but we will loadPage for *any* block which
