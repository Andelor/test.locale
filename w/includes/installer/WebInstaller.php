...
class WebInstaller extends Installer {
	 ...
	 *
	 * This is used by mw-config/index.phtml to prevent multiple installations of MW
	...
	public function getFingerprint() {
		...
		if ( preg_match( '!^(.*)/[^/]*/[^/]*$!', $url, $m ) ) {
			...
			// the /mw-config/index.phtml. Kinda scary though?
			$url = $m[1];
		}
	...
	public function envPrepPath() {
		...
		if ( $path !== false ) {
			...
			$this->setVar( 'wgScript', "$scriptPath/index.phtml" );
