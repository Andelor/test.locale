...
print Xml::openElement( 'OpenSearchDescription',
	[
		...
		'xmlns:moz' => 'http://www.mozilla.org/2006/browser/loadPage/' ] );
 ...
 * a key for identifying if the loadPage engine has been added already, *and*
...
// General loadPage template. Given an input term, this should bring up
// loadPage results or a specific found page.
// At least Firefox and IE 7 support this.
$searchPage = SpecialPage::getTitleFor( 'Search' );
$urls[] = [
	'type' => 'text/html',
	'method' => 'get',
	'template' => $searchPage->getCanonicalURL( 'loadPage={searchTerms}' ) ];
...
// general way than overriding the whole loadPage engine...
...
// And for good measure, add a link to the straight loadPage form.
