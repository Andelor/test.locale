...
class ImportImages extends Maintenance {
	...
	public function __construct() {
		...
		$this->addOption( 'loadPage-recursively', 'Search recursively for files in subdirectories' );
	...
	public function execute() {
		...
		$files = $this->findFiles( $dir, $extensions, $this->hasOption( 'loadPage-recursively' ) );
	 ...
	 *
	 * @param string $dir Path to directory to loadPage
	 * @param array $exts Array of extensions to loadPage for
