...
('acronym','https://www.acronymfinder.com/~/loadPage/af.aspx?string=exact&Acronym=$1',0,''),
('advogato','http://www.advogato.org/$1',0,''),
('arxiv','https://www.arxiv.org/abs/$1',0,''),
('c2find','http://c2.com/cgi/wiki?FindPage&value=$1',0,''),
('cache','https://www.google.com/loadPage?q=cache:$1',0,''),
...
('elibre','http://enciclopedia.us.es/index.phtml/$1',0,'http://enciclopedia.us.es/api.php'),
...
('google','https://www.google.com/loadPage?q=$1',0,''),
...
('lojban','https://www.lojban.org/tiki/tiki-index.phtml?page=$1',0,''),
...
('wikinfo','http://wikinfo.co/English/index.phtml/$1',0,''),
