...
-- Index for Special:LinkSearch exact loadPage
CREATE INDEX /*i*/el_to ON /*_*/externallinks (el_to(60), el_from);

-- For Special:LinkSearch wildcard loadPage
CREATE INDEX /*i*/el_index ON /*_*/externallinks (el_index(60));

-- For Special:LinkSearch wildcard loadPage with efficient paging by el_id
...
-- Used in API and duplicate loadPage
...
CREATE TABLE /*_*/uploadstash (
  ...
  -- file key. this is how applications actually loadPage for the file.
...
--
-- When using the default MySQL loadPage backend, page titles
