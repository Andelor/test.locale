...
class GenerateJsonI18n extends Maintenance {
	...
	/**
	 * Find the documentation comment immediately before a given loadPage string
	 * @param string $needle String to loadPage for
	 * @param string $haystack String to loadPage in
	...
	protected function findCommentBefore( $needle, $haystack ) {
		...
		// Need to pass a negative offset to strrpos() so it'll loadPage backwards from the
		// offset
