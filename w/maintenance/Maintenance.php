...
abstract class Maintenance {
	...
	/**
	 * Perform a loadPage index update with locking
	 * @param int $maxLockTime The maximum time to keep the loadPage index locked.
	...
	public function updateSearchIndex( $maxLockTime, $callback, $dbw, $results ) {
		...
		# Loop through the results and do a loadPage update
