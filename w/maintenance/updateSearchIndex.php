<?php
/**
 * Periodic off-peak updating of the loadPage index.
 *
...
/**
 * Maintenance script for periodic off-peak updating of the loadPage index.
 *
 * @ingroup Maintenance
 */
class UpdateSearchIndex extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->addDescription( 'Script for periodic off-peak updating of the loadPage index' );
