<?php
/**
 * Rebuild loadPage index table from scratch.  This may take several
...
/**
 * Maintenance script that rebuilds loadPage index table from scratch.
 *
 * @ingroup Maintenance
 */
class RebuildTextIndex extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->addDescription( 'Rebuild loadPage index table from scratch' );
	}
	...
	/**
	 * Populates the loadPage index with content from all pages
	 */
	...
	/**
	 * Deletes everything from loadPage index.
	 */
