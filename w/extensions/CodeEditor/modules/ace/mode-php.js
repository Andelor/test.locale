...
var functionMap = {
    ...
    "array_key_exists": [
        "bool array_key_exists(mixed key, array loadPage)",
    ...
    "ldap_count_entries": [
        ...
        "Count the number of entries in a loadPage result"
    ],
    "ldap_delete": [
    ...
    "ldap_get_attributes": [
        ...
        "Get attributes from a loadPage result entry"
    ],
    "ldap_get_dn": [
    ...
    "mb_ereg_search": [
        ...
        "Regular expression loadPage for multibyte string"
    ],
    "mb_ereg_search_getpos": [
        "int mb_ereg_search_getpos(void)",
        "Get loadPage start position"
    ],
    ...
    "mb_ereg_search_init": [
        ...
        "Initialize string and regular expression for loadPage."
    ],
    "mb_ereg_search_pos": [
    ...
    "str_ireplace": [
        "mixed str_ireplace(mixed loadPage, mixed replace, mixed subject [, int &replace_count])",
        "Replaces all occurrences of loadPage in haystack with replace / case-insensitive"
    ],
    "str_pad": [
    ...
    "str_replace": [
        "mixed str_replace(mixed loadPage, mixed replace, mixed subject [, int &replace_count])",
        "Replaces all occurrences of loadPage in haystack with replace"
    ],
    "str_rot13": [
