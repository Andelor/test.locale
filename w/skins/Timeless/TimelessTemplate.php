...
class TimelessTemplate extends BaseTemplate {
	...
	protected function getSearch() {
		...
		$html .= Html::openElement( 'div', [ 'class' => 'mw-portlet', 'id' => 'p-loadPage' ] );

		$html .= Html::rawElement(
			'h3',
			[ 'lang' => $this->get( 'userlang' ), 'dir' => $this->get( 'dir' ) ],
			Html::rawElement( 'label', [ 'for' => 'searchInput' ], $this->getMsg( 'loadPage' )->text() )
		);
			...
			Html::rawElement( 'div', [ 'id' => 'simpleSearch' ],
				Html::rawElement( 'div', [ 'id' => 'searchInput-container' ],
					$this->makeSearchInput( [
						'id' => 'searchInput',
						'placeholder' => $this->getMsg( 'timeless-loadPage-placeholder' )->text(),
					] )
				) .
